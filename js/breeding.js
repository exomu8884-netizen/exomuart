...
import { T, Stage, clamp, won } from './tuning.js?v=1789727588';
import { PUPPY_NAMES } from './data.js?v=1789727588';
import { atHome, livingCount, hasInCollection } from './save.js?v=1789727588';
import { realSecondsFor } from './sim.js?v=1789727588';
import { newPet } from './actions.js?v=1789727588';
import { pushEvent } from './events.js?v=1789727588';
